											...
											<td width=50%>
												...
												<table border=1  >
													<tr>
														...
														<td >
														<input type="text" id=txtId name=txtId size=5>
														</td>
													</tr>
													<tr>
													...
													<tr>
														...
														<td >	<select id =cboPais rows=5>
																	<option value ="PE">PERU</option>
																	<option value ="USA" SELECTED>USA</option>
																	<option value ="E">CANADA</option>
																</select>
														</td>
													</tr>
													<tr>
														<td align=center ><font>Genero</font></td>
														<td >	<select id =cboGenero rows=5>
																	<option value ="PE">ACCION</option>
																	<option value ="EU" SELECTED>DRAMA</option>
																	<option value ="CA">COMEDIA</option>
																</select>
														</td>
													</tr>
												</table>
