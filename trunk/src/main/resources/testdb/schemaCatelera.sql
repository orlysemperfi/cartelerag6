...
drop table T_VENTA if exists;
create table T_VENTA( 
	idVenta bigint generated by default as identity (start with 1),
	fecha date not null,
...
drop table T_DETALLE_VENTA if exists;
create table T_DETALLE_VENTA( 
	item bigint generated by default as identity (start with 1),
	IdVenta integer not null,
	idProducto integer null,
	idHorario integer null,
